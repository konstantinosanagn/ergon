...
def sic_to_vocab(code):
    ...
    specific = {
        ...
        3571: "Semiconductors/Hardware",
        3572: "Semiconductors/Hardware",
        3575: "Semiconductors/Hardware",
        3576: "Semiconductors/Hardware",
        3577: "Semiconductors/Hardware",
        3578: "Semiconductors/Hardware",
        3674: "Semiconductors/Hardware",
        3559: "Semiconductors/Hardware",
        3672: "Semiconductors/Hardware",
        3827: "Semiconductors/Hardware",
        ...
        2711: "Media/Entertainment",
        2721: "Media/Entertainment",
        2731: "Media/Entertainment",
        2741: "Media/Entertainment",
        4832: "Media/Entertainment",
        4833: "Media/Entertainment",
        4841: "Media/Entertainment",
        7310: "Media/Entertainment",
        7311: "Media/Entertainment",
        7812: "Media/Entertainment",
        7819: "Media/Entertainment",
        7822: "Media/Entertainment",
        7841: "Media/Entertainment",
        7900: "Media/Entertainment",
        7990: "Media/Entertainment",
        7997: "Media/Entertainment",
        # biotech / pharma
        2833: "Biotech/Pharma",
        2834: "Biotech/Pharma",
        2835: "Biotech/Pharma",
        ...
        8093: "Healthcare",
        # automotive / mobility
        3711: "Automotive/Mobility",
        3713: "Automotive/Mobility",
        3714: "Automotive/Mobility",
        3715: "Automotive/Mobility",
        3716: "Automotive/Mobility",
        3751: "Automotive/Mobility",
        5500: "Automotive/Mobility",
        5511: "Automotive/Mobility",
        # aerospace / defense
        ...
        3764: "Aerospace/Defense",
        3795: "Aerospace/Defense",
        ...
        2086: "Food/Beverage",
        # travel / hospitality
        4512: "Travel/Hospitality",
        4513: "Logistics/SupplyChain",  # air courier
        4522: "Travel/Hospitality",
        4724: "Travel/Hospitality",
        7011: "Travel/Hospitality",
        7510: "Travel/Hospitality",
        # banking / finance
        6021: "Banking/Finance",
        6022: "Banking/Finance",
        6029: "Banking/Finance",
        6035: "Banking/Finance",
        6036: "Banking/Finance",
        6199: "Fintech",
        6141: "Fintech",
        6324: "Healthcare",  # consumer credit; health-service plans
        6200: "Banking/Finance",
        6211: "Banking/Finance",
        6221: "Banking/Finance",
        6282: "Banking/Finance",
        6311: "Insurance",
        6321: "Insurance",
        6331: "Insurance",
        6351: "Insurance",
        ...
        8711: "Consulting/Services",
        8712: "Consulting/Services",
        8742: "Consulting/Services",
        8748: "Consulting/Services",
        7363: "Consulting/Services",
        7389: "Consulting/Services",
        # education
        8200: "Education",
        8211: "Education",
        8221: "Education",
        8231: "Education",
        # real estate
        6500: "RealEstate/PropTech",
        6510: "RealEstate/PropTech",
        6512: "RealEstate/PropTech",
        6531: "RealEstate/PropTech",
        6552: "RealEstate/PropTech",
        6798: "RealEstate/PropTech",
        # consumer / lifestyle
        2100: "Consumer/Lifestyle",
        2300: "Consumer/Lifestyle",
        2844: "Consumer/Lifestyle",
        3911: "Consumer/Lifestyle",
...
def main():
    ...
    diff = [
        (k, out[k]["sic"], out[k]["sector"], curated[k]["sector"])
        for k in both
        if out[k]["sector"] != curated[k]["sector"]
    ]
