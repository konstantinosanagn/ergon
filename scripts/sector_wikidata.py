...
UA = "ergon-sector-mapper/1.0 (konstantinos.a@tavily.com; deterministic sector map)"
...
IND_MAP = {
    ...
    "capital market": "Banking/Finance",
    "private equity": "Banking/Finance",
    "venture capital": "Banking/Finance",
    "stock exchange": "Banking/Finance",
    "brokerage": "Banking/Finance",
    "accounting": "Banking/Finance",
    "credit": "Banking/Finance",
    "financial market": "Banking/Finance",
    ...
    "cryptocurrency industry": "Crypto/Web3",
    "cryptocurrency exchange": "Crypto/Web3",
    "bitcoin": "Crypto/Web3",
    "blockchain": "Crypto/Web3",
    "ethereum": "Crypto/Web3",
    "web3": "Crypto/Web3",
    "digital currency": "Crypto/Web3",
    # healthcare
    ...
    # biotech / pharma
    "pharmaceutical industry": "Biotech/Pharma",
    ...
    "drug": "Biotech/Pharma",
    "chemical industry": "Manufacturing/Industrial",
    # semiconductors / hardware
    "semiconductor industry": "Semiconductors/Hardware",
    "semiconductor": "Semiconductors/Hardware",
    "semiconductors": "Semiconductors/Hardware",
    "consumer electronics industry": "Semiconductors/Hardware",
    "electronics industry": "Semiconductors/Hardware",
    "electronics": "Semiconductors/Hardware",
    "consumer electronics": "Semiconductors/Hardware",
    "electrical industry": "Semiconductors/Hardware",
    "computer hardware": "Semiconductors/Hardware",
    "networking hardware": "Semiconductors/Hardware",
    "hardware": "Semiconductors/Hardware",
    "integrated circuit": "Semiconductors/Hardware",
    "electrical equipment": "Semiconductors/Hardware",
    "electronic engineering": "Semiconductors/Hardware",
    # cybersecurity
    ...
    "mass media": "Media/Entertainment",
    ...
    "online advertising": "Media/Entertainment",
    "internet marketing": "Media/Entertainment",
    ...
    "online shopping": "E-commerce/Retail",
    "retail industry": "E-commerce/Retail",
    "electronic commerce": "E-commerce/Retail",
    "online marketplace": "E-commerce/Retail",
    "marketplace": "E-commerce/Retail",
    "wholesale": "E-commerce/Retail",
    "grocery store": "E-commerce/Retail",
    "supermarket": "E-commerce/Retail",
    "department store": "E-commerce/Retail",
    "fashion": "Consumer/Lifestyle",
    # consumer / lifestyle
    "consumer goods": "Consumer/Lifestyle",
    "cosmetics": "Consumer/Lifestyle",
    "consumer products": "Consumer/Lifestyle",
    "apparel": "Consumer/Lifestyle",
    "clothing industry": "Consumer/Lifestyle",
    "footwear": "Consumer/Lifestyle",
    "luxury goods": "Consumer/Lifestyle",
    "beauty": "Consumer/Lifestyle",
    "personal care": "Consumer/Lifestyle",
    "furniture": "Consumer/Lifestyle",
    "toys": "Consumer/Lifestyle",
    ...
    "mobile network operator": "Telecom",
    ...
    "broadband": "Telecom",
    # automotive / mobility
    "automotive industry": "Automotive/Mobility",
    "automotive": "Automotive/Mobility",
    "car": "Automotive/Mobility",
    "automobile": "Automotive/Mobility",
    "electric vehicle": "Automotive/Mobility",
    "ride sharing": "Automotive/Mobility",
    "transportation": "Logistics/SupplyChain",
    "mobility": "Automotive/Mobility",
    "automobile manufacturing": "Automotive/Mobility",
    "motorcycle": "Automotive/Mobility",
    # aerospace / defense
    "aerospace": "Aerospace/Defense",
    "aerospace industry": "Aerospace/Defense",
    "aerospace manufacturer": "Aerospace/Defense",
    "defense industry": "Aerospace/Defense",
    "arms industry": "Aerospace/Defense",
    "aviation": "Aerospace/Defense",
    "space industry": "Aerospace/Defense",
    "spaceflight": "Aerospace/Defense",
    "military": "Aerospace/Defense",
    "aeronautics": "Aerospace/Defense",
    # energy / climate
    "energy industry": "Energy/Climate",
    "energy": "Energy/Climate",
    "renewable energy": "Energy/Climate",
    "solar energy": "Energy/Climate",
    "oil and gas industry": "Energy/Climate",
    "petroleum industry": "Energy/Climate",
    "electric power industry": "Energy/Climate",
    "electricity": "Energy/Climate",
    "utility": "Energy/Climate",
    "cleantech": "Energy/Climate",
    "solar power": "Energy/Climate",
    "wind power": "Energy/Climate",
    "nuclear power": "Energy/Climate",
    "oil": "Energy/Climate",
    "natural gas": "Energy/Climate",
    "mining": "Energy/Climate",
    # logistics / supply chain
    "logistics": "Logistics/SupplyChain",
    "supply chain": "Logistics/SupplyChain",
    "supply chain management": "Logistics/SupplyChain",
    "shipping": "Logistics/SupplyChain",
    "freight": "Logistics/SupplyChain",
    "courier": "Logistics/SupplyChain",
    "warehousing": "Logistics/SupplyChain",
    "delivery": "Logistics/SupplyChain",
    "postal service": "Logistics/SupplyChain",
    "transport": "Logistics/SupplyChain",
    # education
    "education": "Education",
    ...
    "real property": "RealEstate/PropTech",
    "property management": "RealEstate/PropTech",
    "construction": "Manufacturing/Industrial",
    "real estate industry": "RealEstate/PropTech",
    "real estate development": "RealEstate/PropTech",
    # consulting / services
    ...
    "heavy industry": "Manufacturing/Industrial",
    "steel industry": "Manufacturing/Industrial",
    "industry": "Manufacturing/Industrial",
    "engineering industry": "Manufacturing/Industrial",
    "metalworking": "Manufacturing/Industrial",
    "industrial manufacturing": "Manufacturing/Industrial",
    "factory": "Manufacturing/Industrial",
    "agriculture": "Manufacturing/Industrial",
    "textile industry": "Manufacturing/Industrial",
    "plastics": "Manufacturing/Industrial",
    "packaging": "Manufacturing/Industrial",
    "paper industry": "Manufacturing/Industrial",
    "industrial design": "Manufacturing/Industrial",
    # travel / hospitality
    "tourism industry": "Travel/Hospitality",
    "tourism": "Travel/Hospitality",
    "hospitality industry": "Travel/Hospitality",
    ...
    "beverage industry": "Food/Beverage",
    "food and beverage": "Food/Beverage",
    "drink industry": "Food/Beverage",
    ...
    "nonprofit": "Government/Public",
    "non-profit organization": "Government/Public",
    "ngo": "Government/Public",
    # extras (seen as unmapped on sample / common Wikidata industry labels)
    "biotechnology industry": "Biotech/Pharma",
    "biopharmaceutical": "Biotech/Pharma",
    "cosmetics industry": "Consumer/Lifestyle",
    "consumer goods industry": "Consumer/Lifestyle",
    "bedding": "Consumer/Lifestyle",
    "sporting activities": "Consumer/Lifestyle",
    "consulting company": "Consulting/Services",
    "management consulting industry": "Consulting/Services",
    "consultation": "Consulting/Services",
    "auditing": "Consulting/Services",
    "accounting services": "Consulting/Services",
    "it service management": "Software/SaaS",
    "it service": "Consulting/Services",
    "it services": "Consulting/Services",
    "data analytics software industry": "Software/SaaS",
    "cloud storage": "Software/SaaS",
    "data analytics": "Software/SaaS",
    "computer programming": "Software/SaaS",
    "medical technology industry": "Healthcare",
    ...
    "water industry": "Energy/Climate",
    "aquaculture": "Food/Beverage",
    "fishing": "Food/Beverage",
    "winemaking": "Food/Beverage",
    "real estate investment trust": "RealEstate/PropTech",
    "coworking": "RealEstate/PropTech",
    "transportation industry": "Logistics/SupplyChain",
    "railroad": "Logistics/SupplyChain",
    "maritime transport": "Logistics/SupplyChain",
    "trucking industry": "Logistics/SupplyChain",
    # second round of unmapped labels seen on the full run
    "rail transport": "Logistics/SupplyChain",
    "public transport": "Logistics/SupplyChain",
    "passenger transport": "Logistics/SupplyChain",
    "transport industry": "Logistics/SupplyChain",
    "air transport": "Travel/Hospitality",
    "air transportation": "Travel/Hospitality",
    "shipbuilding": "Manufacturing/Industrial",
    "metal industry": "Manufacturing/Industrial",
    "creative industries": "Media/Entertainment",
    "anime industry": "Media/Entertainment",
    "market research": "Consulting/Services",
    "financial sector": "Banking/Finance",
    "computer hardware industry": "Semiconductors/Hardware",
    "health care industry": "Healthcare",
    "health technology industry": "Healthcare",
    "bicycle industry": "Consumer/Lifestyle",
    "game industry": "Gaming",
    "it systems and software consulting": "Consulting/Services",
    "professional service": "Consulting/Services",
    "business software industry": "Software/SaaS",
    "cannabis industry": "Consumer/Lifestyle",
    "technology": "Software/SaaS",
    "information technology industry": "Software/SaaS",
    "business and other management consultancy activities": "Consulting/Services",
    "economics of banking": "Banking/Finance",
    "quantum computing industry": "Semiconductors/Hardware",
    ...
    "construction industry": "Manufacturing/Industrial",
    "building materials": "Manufacturing/Industrial",
    "fashion industry": "Consumer/Lifestyle",
    "jewellery": "Consumer/Lifestyle",
    "tobacco industry": "Consumer/Lifestyle",
    "retail banking": "Banking/Finance",
    "social media industry": "Media/Entertainment",
    "search engine": "Software/SaaS",
    ...
    "electricity generation": "Energy/Climate",
    "public utility": "Energy/Climate",
    "fast food": "Food/Beverage",
    "sports industry": "Consumer/Lifestyle",
    "internet portal": "Software/SaaS",
    "computer network": "Software/SaaS",
    "film production": "Media/Entertainment",
    "show business": "Media/Entertainment",
    "publishing house": "Media/Entertainment",
    "publishing industry": "Media/Entertainment",
    "weapons industry": "Aerospace/Defense",
    "aircraft industry": "Aerospace/Defense",
    "commercial aviation": "Travel/Hospitality",
    "taxi service": "Automotive/Mobility",
    "hospitals and rehabilitation": "Healthcare",
    "hospital industry": "Healthcare",
    "hedge fund": "Banking/Finance",
    ...
    "e-commerce industry": "E-commerce/Retail",
...
def label_query(cands):
    ...
    return (
        "SELECT ?cand ?company ?sl ?indLabel WHERE { VALUES ?cand { " + vals + " } "
...
def domain_query(url_to_dom):
    ...
    return (
        "SELECT ?url ?company ?sl ?indLabel WHERE { VALUES ?url { " + vals + " } "
...
def main():
    ...
    if from_cache:
        with open(RAW_JSON) as fh:
            rawc = json.load(fh)
        raw = {
            k: {q: {"sl": v["sl"], "ind": set(v["ind"])} for q, v in qm.items()}
    ...
    def save_cache():
        if sample:
            return
        rawc = {
            k: {q: {"sl": v["sl"], "ind": sorted(v["ind"])} for q, v in qm.items()}
...
def finish(raw, companies, curated, sample):
    ...
    if both:
        miss = [
            (k, result[k]["sector"], curated[k]["sector"], result[k]["wd_industry"])
            for k in both
            if result[k]["sector"] != curated[k]["sector"]
        ]
