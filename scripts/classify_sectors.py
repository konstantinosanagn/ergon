...
_TLD: dict[str, str] = {
    ...
    ".realestate": "RealEstate/PropTech",
    ".estate": "RealEstate/PropTech",
    ".homes": "RealEstate/PropTech",
    ".travel": "Travel/Hospitality",
    ".media": "Media/Entertainment",
    ".fm": "Media/Entertainment",
...
def main() -> None:
    ...
    print(
        f"  coverage: {matched / total:.0%}  accuracy-on-labeled: {correct / matched:.0%}  overall: {correct / total:.0%}"
    )
