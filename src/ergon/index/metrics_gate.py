...
The publish gates (:mod:`ergon.index.gates`) protect the raw row count, but the build's
...
:func:`ergon.index.freshness.check_expiry_alarms`: it never blocks a publish (that is the
...
class MetricsRegressionReport:
    """Mirror of :class:`ergon.index.gates.GateReport` for the metrics tripwire."""
