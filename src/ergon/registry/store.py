...
The seed ships as packaged data (``ergon/registry/data/seed.json``) and is loaded via
:mod:`importlib.resources`, so it resolves correctly whether ergon is run from a source
...
_DATA_PACKAGE = "ergon.registry.data"
