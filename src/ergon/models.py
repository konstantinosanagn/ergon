"""Canonical data models for ergon — the FROZEN CONTRACT all providers normalize to.
...
class SearchResult(BaseModel):
    ...
    def to_pandas(self) -> Any:  # optional dep, dynamic return type
        try:
            ...
            raise ImportError("DataFrame export needs: pip install 'ergon[pandas]'") from exc
    ...
    def to_polars(self) -> Any:  # optional dep, dynamic return type
        try:
            ...
            raise ImportError("DataFrame export needs: pip install 'ergon[polars]'") from exc
