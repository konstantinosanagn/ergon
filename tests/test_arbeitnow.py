...
from ergon.providers.arbeitnow import ArbeitnowProvider
...
def test_employment_mapping() -> None:
    from ergon.providers.arbeitnow import _employment
...
def test_parse_epoch_handles_garbage() -> None:
    from ergon.providers.arbeitnow import _parse_epoch
