...
# level recall 90.5%, scope 62.5%, precision 99.5%); raise as degree.py improves.
LEVEL_RECALL_GATE = 0.88  # degree_min (the level) — production-grade
SCOPE_ACC_GATE = 0.60  # degree_required (required-vs-preferred) — the genuinely hard half; honest,
